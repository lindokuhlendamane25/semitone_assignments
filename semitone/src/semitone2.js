...
let flats = ['no', 'bFlat', 'no', 'no', 'dflat','no','eflat','no','no','gflat','no','aflat'];
class JamBuddy{
   constructor(){
       this.num1;
       this.num2;
   ...
   //select two different notes
       ...
       var flat4=['F#','gFlat']
       var flat5=['G#','aFlat']
       // var flatNum2=Math.floor(Math.random()*2);
       if(note1==='A#'){
       ...
       var arr = [note1, note2];
       return document.getElementById("notes").innerHTML = arr;
   }
   checkAnswer(){
   ...
   if(result === userAnswer){
       var ans = "You got it right .Well Done";
   }else{
